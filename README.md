# Social Network: Media Filament

> This optional Filament 5 presentation package presents exactly one independent domain module. It contributes reusable resources, pages, widgets, schemas, tables, infolists, and actions to application-owned panels while delegating authorization, validation, tenancy, persistence, and business rules to the social-network-media public boundary. It mu
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-social-network-media-filament?sort=semver)](https://github.com/liberusoftware/module-social-network-media-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-social-network-media-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-social-network-media-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-social-network-media-filament
```
...
<a href="https://github.com/liberusoftware/module-social-network-media-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-social-network-media-filament" alt="Contributors to liberusoftware/module-social-network-media-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-social-network-media-filament/graphs/contributors).
